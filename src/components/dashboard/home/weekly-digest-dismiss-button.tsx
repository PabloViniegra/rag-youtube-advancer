...
export function WeeklyDigestDismissButton({
  ...
  return (
    <button
      ...
      className="inline-flex h-7 w-7 items-center justify-center rounded-lg text-on-surface-variant/60 transition-colors hover:bg-tertiary-container hover:text-on-tertiary-container disabled:cursor-not-allowed disabled:opacity-40"
    >
      <CloseIcon />
    </button>
  )
